      ...
      <table class="table table-hover">
        ...
        <tbody>
          <tr>
            ...
            <td><input type="text" class="form-control productname" name=""></td>
            <td><input type="number" min="1" class="form-control productnumber" name=""></td>
            <td><input type="text" class="form-control unit" name=""></td>
            <td><input type="text" class="form-control keystore" name=""></td>
            <td><input type="number" min="1" class="form-control price" name=""></td>
  ...
  $(document).ready(function() {
    ...
    $('#addrow').click(function(e) {
      ...
      $('tbody').append('<tr><td class="text-center"><label class="col-form-label">' + (index++) + '</label></td><td>' +
        '<input type="text" class="form-control productname"></td>' +
        '<td><input type="number" min="1" class="form-control productnumber"></td>' +
        '<td><input type="text" class="form-control unit"></td>' +
        '<td><input type="text" class="form-control keystore"></td>' +
