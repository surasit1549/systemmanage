...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-white">{{ __('สมัครสมาชิก') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="first_name" type="text" class="form-control @error('name') is-invalid @enderror" name="first_name" value="{{ old('name') }}" required autocomplete="off" autofocus>
                                @error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="custom-select" name="" id="">
                                    ...
                                    <option value="ผู้มีอำนาจ1">ผู้มีอำนาจ 1</option>
                                    <option value="ผู้มีอำนาจ2">ผู้มีอำนาจ 2</option>
                                </select>
                                @error('name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-md-4 col-form-label text-md-right">{{ __('ที่อยู่') }}</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="#" onclick="window.history.back()" class="text-white btn btn-secondary">
                                    {{ __('ย้อนกลับ') }}
                                </a>
                            </div>
                        </div>
